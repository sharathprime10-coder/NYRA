              ...
              <div style={{ transform: "translateZ(20px)" }} className="p-6 flex flex-col gap-6 bg-surface-container-low/30 min-h-[320px] text-left">
                ...
                <div className="flex items-start gap-4 max-w-[90%]">
                  <div className="w-8 h-8 rounded-full overflow-hidden shrink-0 shadow-lg shadow-primary/20 relative lock-on-hover cursor-default">
                    ...
                    <img alt="NYRA AI" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBZFpqBmp9Q0IvEwQI0YLO1msP2m9pFaeYam2iZh5GouMGbktH1LaE_877pnOp8a6INqSGa6sngvUE_mXps7akfabw-hes3X6HB3efO91IpQyIoo2oVXs-TLrVGjhayp72iRxd9xKHvb2W83TkXFhQF990ih7eaSwFlCSWqPyHgvIvOr8nIcaUl1LM4371ntKxwcgxhPUFnOGuZ8FQHfS4xZCd9R2xH-ZSRRNq_VmqxWbredR_tOxQ5NvnPfIrQbTpPwBw" />
                  </div>
